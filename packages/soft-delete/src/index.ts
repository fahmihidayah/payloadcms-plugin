    ...
    config.admin = {
      ...
      components: {
        ...
        providers: [
          ...
          "payloadcms-soft-delete/rsc#SoftDeleteProviderRsc",
        ],
      },
    };
      ...
      modifiedCollection.admin = {
        ...
        components: {
          ...
          beforeList: [
            ...
            "payloadcms-soft-delete/client#ToggleButton",
          ],
          beforeListTable: [
            ...(modifiedCollection.admin?.components?.beforeListTable || []),
            "payloadcms-soft-delete/client#BulkSoftDeleteButton",
            {
              path: "payloadcms-soft-delete/client#BulkDeleteButton",
              clientProps: {
                enabled: enableHardDelete,
              },
            },
            {
              path: "payloadcms-soft-delete/client#BulkRestoreButton",
              clientProps: {
                enabled: enableRestore,
              },
            },
            {
              path: "payloadcms-soft-delete/client#VisibilityChecker",
              clientProps: {
                enabledCollections,
              },
            },
      ...
      modifiedCollection.fields = [
        ...
        },
        {
          ...
          admin: {
            ...
            disableListColumn: true,
            components: {
              Field: "payloadcms-soft-delete/client#RestoreButton",
            },
            custom: {
              enabled: enableRestore,
            },
        ...
        },
        {
          ...
          admin: {
            ...
            disableListColumn: true,
            components: {
              Field: "payloadcms-soft-delete/client#SoftDeleteButton",
            },
          },
        },
        {
          ...
          admin: {
            ...
            disableListColumn: true,
            components: {
              Field: "payloadcms-soft-delete/client#DeleteButton",
            },
            custom: {
              enabled: enableHardDelete,
            },
        ...
        },
        {
          ...
          admin: {
            ...
            disableListColumn: true,
            components: {
              Field: "payloadcms-soft-delete/client#VisibilityChecker",
            },
            custom: {
